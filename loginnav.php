		...
		<div class="container">
			...
			<div id="navbar" class="navbar-collapse collapse text-center">
				<ul class="nav navbar-nav">
							...
							<div class="row">
								...
								<div class="col-lg-6 col-md-6 mb-sm-3">
									<ul>
										...
										<li><a href="confirmation.php">Confirmação</a></li>
							...
							<div class="row">
								...
								<div class="col-sm-3 col-xs-12">
									<ul>
										...
										<li role="separator" class="divider"></li>
										<li><a href="dashboard.php">Interface do Usuário</a></li>
										<li><a href="order.php">Pedidos</a></li>
										<li><a href="address.php">Endereços</a></li>
										<li><a href="profile-details.php">Detalhes dos Perfis</a></li>
									</ul>
								</div>
					...
					<li class="dropdown full-width dropdown-slide">
						<a href="#!" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="350"
							role="button" aria-haspopup="true" aria-expanded="false"> Acesso Restrito <span
								class="tf-ion-ios-arrow-down"></span></a>
						<div class="dropdown-menu">
							<div class="row">
								...
								<div class="col-sm-3 col-xs-12">
									<ul>
										...
										<li role="separator" class="divider"></li>
										<li><a href="./categoria.form">Categorias</a></li>
										<li><a href="./novidade.form">Novidades</a></li>
										<li><a href="./produto.form">Produtos</a></li>
										<li><a href="./signin">Usuários</a></li>
									</ul>
								</div>
