...
<section class="page-section" id="novidades">
    <div class="container">
        ...
        <form id="novidadesForm" data-sb-form-api-token="API_TOKEN" method="POST" action="novidade.register">
            <div class="row align-items-center mb-5 offset-4">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <!-- Direction input-->
                        <input class="form-control"id="direction" name="inputDirecao" type="text" placeholder="Informe a Direcao *" data-sb-validations="required" />
                    ...
                    <div class="form-group mb-md-0">
                        <!-- Descrição2 input-->
                        <input class="form-control"  id="description2" name="inputDescricao2" type="text" placeholder="Informe a descrição *" data-sb-validations="required" />
