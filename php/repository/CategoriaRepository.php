...
class CategoriaRepository
{
    ...
    function fnAddCategoria($categoria): bool
    {
        try {

            $query = "INSERT INTO categoria (imagem, nome, descricao) VALUES (:pimagem, :pnome, :pdescricao) ON conflict do nothing";

            $stmt = $this->conn->prepare($query);
            $stmt->bindValue(":pimagem", $categoria->getImagem());
            $stmt->bindValue(":pnome", $categoria->getNome());
            $stmt->bindValue(":pdescricao", $categoria->getDescricao());
    ...
    function fnUpdateCategoria($categoria): bool
    {
        try {
            ...
            $query = "UPDATE categoria SET imagem = :pimagem, nome = :pnome, descricao = :pdescricao WHERE id = :pid";
    ...
    public function fnListCategorias($limit) {
        try {
            ...
            $query = "select id, imagem, nome, descricao, criado_em criadoem from categoria limit :plimit";
    ...
    public function fnLocalizarCategoria($id) {
        try {
            ...
            $query = "SELECT id, imagem, nome, descricao, criado_em criadoEm FROM categoria WHERE id = :pid";
