<?php
    ...
    define('GUSER', 'Administrador@jubileucamisas.com.br');
    define('GPWD', 'Jubileu@9090');
    ...
    function enviarEmail(Usuario $usuario)
    {
        ...
        $mail->Username = GUSER;
        $mail->Password = GPWD;
        $mail->setFrom(GUSER, 'Jubileu Camisas');
    ...
    function montaMsg(string $senha)
    {
        ...
        . "</head>"
        . "<body>"
            . "<h1>Recuperação senha <strong>Jubileu</strong>Camisas</h1>"
            . "<div align=\"center\">"
    ...
    function redirectLogin($status, $msg)
    {
        ...
        header('location: /Integrador/JubileuCamisas/index');
        exit;
    }